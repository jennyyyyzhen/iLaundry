...
public class SouthDorm extends AppCompatActivity {
    DatabaseReference database = FirebaseDatabase.getInstance().getReference();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_south_dorm);
        setButtonDisplay("South_dryer_1");
        setButtonDisplay("South_dryer_2");
        setButtonDisplay("South_dryer_3");
        setButtonDisplay("South_washer_1");
        setButtonDisplay("South_washer_2");
        setButtonDisplay("South_washer_3");
    }
    ...
    private void startTimer(View view, long timeInMili) {
        ...
        CountDownTimer countDownTimer = new CountDownTimer(timeInMili, 1000) {
            ...
            public void onTick(long l) {
                button.setText(Long.toString(l/1000)+" seconds");
            }

            public void onFinish() {
                button.setText("true");
                addNotification("South");
            }
        }.start();
    }
