...
public class SontagDorm extends AppCompatActivity {
    DatabaseReference database = FirebaseDatabase.getInstance().getReference();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sontag_dorm);
        setButtonDisplay("Sontag_dryer_1");
        setButtonDisplay("Sontag_dryer_2");
        setButtonDisplay("Sontag_dryer_3");
        setButtonDisplay("Sontag_dryer_4");
        setButtonDisplay("Sontag_dryer_5");
        setButtonDisplay("Sontag_washer_1");
        setButtonDisplay("Sontag_washer_2");
        setButtonDisplay("Sontag_washer_3");
        setButtonDisplay("Sontag_washer_4");
        setButtonDisplay("Sontag_washer_5");
