...
public class NorthDorm extends AppCompatActivity {
    DatabaseReference database = FirebaseDatabase.getInstance().getReference();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_north_dorm);
        setButtonDisplay("North_dryer_1");
        setButtonDisplay("North_dryer_2");
        setButtonDisplay("North_dryer_3");
        setButtonDisplay("North_washer_1");
        setButtonDisplay("North_washer_2");
        setButtonDisplay("North_washer_3");
    }
