...
public class CaseDorm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_case_dorm);
        setTimeDisplay("Case_dryer_1");
        setTimeDisplay("Case_dryer_2");
        setTimeDisplay("Case_dryer_3");
        setTimeDisplay("Case_dryer_4");
        setTimeDisplay("Case_dryer_5");
        setTimeDisplay("Case_washer_1");
        setTimeDisplay("Case_washer_2");
        setTimeDisplay("Case_washer_3");
        setTimeDisplay("Case_washer_4");
        setTimeDisplay("Case_washer_5");
    }
    ...
    */
    public void changeStatus(View view) {
        ...
        TextView text = (TextView) findViewById(R.id.case_dorm).findViewWithTag(textTag);
    ...
    */
    ...
    private void displayAvailableMachine(){
        ...
        DatabaseReference node = database.child("Case").child("washer");
        node.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
