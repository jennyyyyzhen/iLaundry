...
public class CaseDorm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setButtonDisplay("Case_dryer_1");
        setButtonDisplay("Case_dryer_2");
        setButtonDisplay("Case_dryer_3");
        setButtonDisplay("Case_dryer_4");
        setButtonDisplay("Case_dryer_5");
        setButtonDisplay("Case_washer_1");
        setButtonDisplay("Case_washer_2");
        setButtonDisplay("Case_washer_3");
        setButtonDisplay("Case_washer_4");
        setButtonDisplay("Case_washer_5");
    }
